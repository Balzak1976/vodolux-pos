...
export function CellDiscountMenuBtn({
	...
	return (
		<Menu shadow='md' position='top' closeOnItemClick={false}>
			<Menu.Target>
				<Button w={'4rem'} variant={menuBtnStyle} compact={menuBtnCompact}>
					{children}
				</Button>
			</Menu.Target>
			...
			<Menu.Dropdown>
				...
				<Flex pr={'0.75rem'} gap='xs' align='center'>
					<NumberInput
						pl={'0.75rem'}
						py={'0.625rem'}
					...
					/>
					<LockBtn unLock={canDiscount} onClick={onResetLocalDiscount} />
				</Flex>
			</Menu.Dropdown>
		</Menu>
	);
